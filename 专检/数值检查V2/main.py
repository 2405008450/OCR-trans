...
def run_comparison(original_path, translated_path, use_ai_rule=False):
    ...
    parts = [
        ("正文", original_body, translated_body,
         r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\zhengwen\output_json"),
        ("页眉", original_header, translated_header,
         r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\yemei\output_json"),
        ("页脚", original_footer, translated_footer,
         r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\yejiao\output_json")
    ]
    report_paths = {}
...
def main():
    # 1) 配置默认路径
    DEFAULT_ORIGINAL = r"E:\Archive\memory\data\原文.docx"
    DEFAULT_TRANSLATED = r"E:\Archive\memory\data\译文.docx"
    ...
    if is_pdf_workflow:
        ...
        if translated_ext == ".pdf":
            ...
            try:
                ...
                # 正文excel
                body_target_folder = r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\yejiao\output_excel"
                body_file_path, body_data = e.get_excel(body_errors, output_dir=body_target_folder)
                print(f"✓ 正文报告已存至: {body_file_path}")

                # 页眉excel
                header_target_folder = r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\yemei\output_excel"
                header_file_path, header_data = e.get_excel(header_errors, output_dir=header_target_folder)
                print(f"✓ 页眉报告已存至: {header_file_path}")

                # 页脚excel
                footer_target_folder = r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\zhengwen\output_excel"
    ...
    if is_excel_workflow:
        ...
        try:
            ...
            body_target_folder = r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\zhengwen\output_excel"
            ...
            footer_target_folder = r"C:\Users\Administrator\Desktop\数值检查V2\llm\llm_project\yejiao\output_excel"
