...
from llm.llm_project.parsers.pdf.to_pdf import CompletePDFExtractor, ContentFormatter
...
if __name__ == "__main__":
    pdf_path=r"C:\Users\Administrator\Desktop\项目文件\专检\数值检查1\测试文件\原文-数值检查测试文件1.pdf"
