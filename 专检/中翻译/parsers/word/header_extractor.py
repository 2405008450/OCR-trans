...
def extract_headers(doc_path: str) -> List[str]:
    """
    提取 docx 的所有页眉段落（按 header1.xml, header2.xml... 顺序）
...
if __name__ == "__main__":
    # 示例：python header_extractor.py your.docx
    # import sys, os
    #
    # if len(sys.argv) < 2:
    #     print("用法: python header_extractor.py <docx_path>")
    #     raise SystemExit(1)
    #
    ...
    original_path = r"C:\Users\H\Desktop\测试项目\中翻译\测试文件\更新_20260321 泰格医药2025年度可持续发展报告 V2.33-to翻译（修订标记）_Bilingual.docx"
    translated_path = r"C:\Users\H\Desktop\测试项目\中翻译\测试文件\更新_20260321 泰格医药2025年度可持续发展报告 V2.33-to翻译（修订标记）_Bilingual.docx"  # trans_docx_path = translated_path

    # 提取文件中的文本
    original_doc_path = original_path
    original_text = extract_headers(original_doc_path)
    translated_text = extract_headers(translated_path)
    print(original_text)
