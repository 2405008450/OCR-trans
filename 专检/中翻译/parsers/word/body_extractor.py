...
if __name__ == "__main__":
    ...
    #     raise SystemExit(1)
    # body_result_path=r"C:\Users\Administrator\Desktop\zhongfanyi_spilite\llm\llm_project\zhengwen\output_json\文本对比结果_20260304_162055.json"
    ...
    # 示例文件路径
    original_path = r"C:\Users\Administrator\Desktop\中翻译通用规则项目\zhongfanyi\测试文件\测试文档.doc"
    translated_path = r"C:\Users\Administrator\Desktop\中翻译规则检查\测试文件\译文-中翻译测试文件2.docx"    # trans_docx_path = translated_path
