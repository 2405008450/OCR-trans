...
if __name__ == "__main__":
    docx_path = r"D:\project\数检_程序-AI\测试文件\译文-含不可编辑_01 (2026-007)2025年年度报告(1).docx"
    out_path = r"D:\project\数检_程序-AI\测试文件\译文-含不可编辑_01 (2026-007)2025年年度报告_output.docx"
