...
if __name__ == "__main__":
    ...
    print("=== 示例1：添加批注 ===")
    with PDFAnnotator(
            r"C:\Users\Administrator\Desktop\项目文件\专检\数值检查1\测试文件\译文-数值检查测试文件1.pdf") as annotator:
        # 查找并高亮所有 "2024" 文本
        count = annotator.highlight_and_comment(
            search_text="2024",
            comment="年份需要更新为2025",
        ...
        # 保存
        annotator.save("example_annotated.pdf")

    # 示例2：替换文本
    print("\n=== 示例2：替换文本 ===")
    with PDFTextReplacer(
            r"C:\Users\Administrator\Desktop\项目文件\专检\数值检查1\测试文件\译文-数值检查测试文件1.pdf") as replacer:
        # 替换所有 "2024" 为 "2025"
        count = replacer.replace_text("2024", "2025")
        print(f"替换了 {count} 处文本")

        # 保存
        replacer.save("example_replaced.pdf")
