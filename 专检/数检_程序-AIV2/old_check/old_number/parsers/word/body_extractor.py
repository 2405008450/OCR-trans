...
if __name__ == "__main__":
    ...
    translated_path = r"C:\Users\H\Desktop\测试项目\中翻译\测试文件\中英对照-含不可编辑_20260401 【翻译同步】迦南智能2025年度可持续发展报告初稿V2.9_Bilingual_corrected.docx"    # trans_docx_path = translated_path
