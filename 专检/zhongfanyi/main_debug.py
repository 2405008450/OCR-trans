...
def run_comparison(original_path, translated_path, use_ai_rule=False):
    ...
    # 规则文件路径
    custom_path = r"C:\Users\Administrator\Desktop\中翻译通用规则项目\zhongfanyi\llm\llm_project\rule\自定义规则.txt"
    default_path = r"C:\Users\Administrator\Desktop\中翻译通用规则项目\zhongfanyi\llm\llm_project\rule\默认规则.txt"
    rule_backup_dir = r"C:\Users\Administrator\Desktop\中翻译通用规则项目\zhongfanyi\llm\llm_project\rule"
...
def main():
    # 1) 配置默认路径
    DEFAULT_ORIGINAL = r"C:\Users\Administrator\Desktop\中翻译通用规则项目\zhongfanyi\测试文件\原文-中翻译规则测试文件.docx"
    DEFAULT_TRANSLATED = r"C:\Users\Administrator\Desktop\中翻译通用规则项目\zhongfanyi\测试文件\译文-中翻译规则测试文件.docx"
