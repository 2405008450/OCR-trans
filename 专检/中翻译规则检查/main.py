...
def main():
    # 1) 配置默认路径
    DEFAULT_ORIGINAL = r"C:\Users\Administrator\Desktop\project\llm\文本对比结果\加粗斜体测试\原文-加粗斜体.docx"
    DEFAULT_TRANSLATED = r"C:\Users\Administrator\Desktop\project\llm\文本对比结果\加粗斜体测试\译文-加粗斜体.docx"
